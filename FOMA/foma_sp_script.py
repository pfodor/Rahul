...
def sp(sp,alphabet, minWordLength, maxWordLength, fPath, spDirectory,fomaWriteFile):
    dpath = './foma_scripts'
...
sp('sp2n', alphabet, 1, 12, 'sp2negative_3', './foma_outputs/sp2negative_3','../foma_outputs/sp2negative_3/sp2negative_3')
#sp('sp2p', alphabet, 1, 12, 'sp2positive_3', '../foma_outputs/sp2positive_3')
sp('sp4n', alphabet, 1, 12, 'sp4negative_3', './foma_outputs/sp4negative_3','../foma_outputs/sp4negative_3/sp4negative_3')
#sp('sp4p', alphabet, 1, 12, 'sp4positive_3', '../foma_outputs/sp4positive_3')
sp('sp8n', alphabet, 1, 12, 'sp8negative_3', './foma_outputs/sp8negative_3','../foma_outputs/sp8negative_3/sp8negative_3')
...
sp('sp2n', alphabet, 1, 5, 'sp2negative_10', './foma_outputs/sp2negative_10','../foma_outputs/sp2negative_10/sp2negative_10')
#sp('sp2p', alphabet, 1, 8, 'sp2positive_10', '../foma_outputs/sp2positive_10')
sp('sp4n', alphabet, 1, 8, 'sp4negative_10', './foma_outputs/sp4negative_10','../foma_outputs/sp4negative_10/sp4negative_10')
#sp('sp4p', alphabet, 1, 8, 'sp4positive_10', '../foma_outputs/sp4positive_10')
sp('sp8n', alphabet, 1, 8, 'sp8negative_10', './foma_outputs/sp8negative_10','../foma_outputs/sp8negative_10/sp8negative_10')
...
sp('sp2n', alphabet, 1, 5, 'sp2negative_56', './foma_outputs/sp2negative_56','../foma_outputs/sp2negative_56/sp2negative_56')
#sp('sp2p', alphabet, 1, 10, 'sp2positive_56', '../foma_outputs/sp2positive_56')
sp('sp4n', alphabet, 1, 7, 'sp4negative_56', './foma_outputs/sp4negative_56','../foma_outputs/sp4negative_56/sp4negative_56')
#sp('sp4p', alphabet, 1, 10, 'sp4positive_56', '../foma_outputs/sp4positive_56')
sp('sp8n', alphabet, 1, 10, 'sp8negative_56', './foma_outputs/sp8negative_56','../foma_outputs/sp8negative_56/sp8negative_56')
